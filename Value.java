package Caro.CaroMini.caro.values;
...
public class Value {
	...
	public static final String INFO_MESSAGE = 
		...
		+ "Nguyễn Tiến Phát - 2001210346\n"
		+ "Đặng Hoàng Phúc - 2001216046\n"
		+ "Phạm Minh Nhật - 2001210739\n"
		+ "Nội dung:\n"
	...
	public static final String INTRODUCE_MESSAGE = 
		...
		+ " Cờ ca-rô trong tiếng Triều Tiên là omok , tiếng Trung là (bính âm: wǔzǐqí)"
		+ " và trong tiếng Nhật là (gomoku narabe); tiếng Anh, sử dụng lại tiếng Nhật, gọi là gomoku."
		+ "\r\n" 
